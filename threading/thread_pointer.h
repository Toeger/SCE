...
struct Thread_pointer {
	...
	template <class U>
	friend auto operator_spaceship(const Thread_pointer<U> &lhs, const Thread_pointer<U> &rhs) {
		//return std::compare_3way(lhs.t, rhs.t);
		return std::less<>{}(lhs.t, rhs.t) ? -1 : std::less<>{}(rhs.t, lhs.t) ? 1 : 0;
	}
	template <class U>
	friend auto operator_spaceship(const Thread_pointer<U> &lhs, std::nullptr_t rhs) {
		//return std::compare_3way(lhs.t, rhs);
		return std::less<>{}(lhs.t, rhs) ? -1 : std::less<>{}(rhs, lhs.t) ? 1 : 0;
	}
	template <class U>
	friend auto operator_spaceship(std::nullptr_t lhs, const Thread_pointer<U> &rhs) {
		//return std::compare_3way(lhs, rhs.t);
		return std::less<>{}(lhs, rhs.t) ? -1 : std::less<>{}(rhs.t, lhs) ? 1 : 0;
	}
	template <class U>
	friend auto operator_spaceship(const Thread_pointer<U> &lhs, U *rhs) {
		//return std::compare_3way(lhs.t, rhs);
		return std::less<>{}(lhs.t, rhs) ? -1 : std::less<>{}(rhs, lhs.t) ? 1 : 0;
	}
	template <class U>
	friend auto operator_spaceship(U *lhs, const Thread_pointer<U> &rhs) {
		//return std::compare_3way(lhs, rhs.t);
		return std::less<>{}(lhs, rhs.t) ? -1 : std::less<>{}(rhs.t, lhs) ? 1 : 0;
	}
};
